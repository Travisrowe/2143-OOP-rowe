...
| ***2*** | ***Add Method***                                           |             |          |                |
| -       | Employed some kind of gcd method                           |    30       |    0     | ![Alt text][2] |
| -       | Handled a whole number portion of the fraction             |    30       |    30    | ![Alt text][1] |
| ***2*** | ***Overloaded Add Operator***                              |             |          |                |
| -       | `__add__` existed and worked                               |    30       |    15    | ![Alt text][3] |
|         | Totals:                                                    | **100**     |  **55**  | ![Alt text][2] |

### Comments:
```
no main, add exists but rest of code is lacking. If you need help see Dr Griffin. 
```
